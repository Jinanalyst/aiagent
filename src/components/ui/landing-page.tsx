            ...
            <div className="grid gap-3 lg:grid-cols-[1fr_400px] lg:gap-3 xl:grid-cols-[1fr_600px]">
              ...
              >
                <div className="relative h-[350px] w-full md:h-[450px] lg:h-[500px] xl:h-[550px] overflow-hidden rounded-3xl">
                  <Image
                    src="https://source.unsplash.com/random/800x600?technology,abstract"
                    alt="Hero Image"
                    fill
              ...
              {[...Array(6)].map((_, i) => (
                ...
                >
                  <div className="rounded-3xl border p-6 bg-background/80 hover:shadow-md transition-all">
                    <Image
                      src={`https://source.unsplash.com/random/160x80?logo,minimal&sig=${i}`}
                      alt={`Client Logo ${i + 1}`}
                      width={160}
                      height={80}
          ...
          >
            ...
            >
              ...
              >
                ...
                <Image
                  src="https://source.unsplash.com/random/1200x800?design,portfolio"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://source.unsplash.com/random/600x600?design,app"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://source.unsplash.com/random/600x600?branding,tech"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://source.unsplash.com/random/600x600?dashboard,saas"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://source.unsplash.com/random/1200x600?marketing,campaign"
            ...
            <div className="grid gap-3 lg:grid-cols-2 lg:gap-3">
              ...
              >
                <div className="relative h-[350px] w-full md:h-[450px] lg:h-[500px] overflow-hidden rounded-3xl">
                  <Image
                    src="https://source.unsplash.com/random/1080x800?team,office"
                    alt="Team Photo"
                    fill
                    className="object-cover"
                  />
            ...
            <div className="mt-16 px-6 pb-10">
              ...
              >
                {[
                  ...
                  >
                    <Image
                      src={`https://source.unsplash.com/random/300x400?portrait,person&sig=${index}`}
                      alt={member.name}
                      width={300}
                      height={400}
